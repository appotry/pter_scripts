...
function make_better(){
    ...
    append:location.append('<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source16" name="source16"  value="1"><a href="?cat409=yes&source=16" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="Windows" title="Windows" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/Windows.png);"></a></td>\n' +
        ...
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source46" name="source46"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="Linux" title="Linux" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/Linux.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source37" name="source37"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="MAC" title="MAC" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/MAC.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source24" name="source24"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="GBA" title="GBA" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/GBA.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source21" name="source21"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="FC_NES" title="FC_NES" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/FC_NES.png);"></a></td>\n');
    $("input[name='cat_check']").remove();
    const aim = $("input#cat412").parent().next();
    aim.siblings().remove();
    aim.before('<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source17" name="source17"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="DOS" title="DOS" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/DOS.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source34" name="source34"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="PSP" title="PSP" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/PSP.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source33" name="source33"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="PS2" title="PS2" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/PS2.png);"></a></td>\n' +
        '<td class="bottom" style="padding-bottom: 4px; padding-left: 3px;" align="left"> <input type="checkbox" id="source35" name="source35"  value="1"><a href="?cat409=yes&source=31" one-link-mark="yes"><img class="c_game" src="pic/cattrans.gif" alt="PS3" title="PS3" style="background-image: url(pic/category/chd/scenetorrents/chs/additional/PS3.png);"></a></td>\n')
}
$(function(){
    make_better();
